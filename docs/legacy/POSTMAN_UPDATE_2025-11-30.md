...
Updated the Giga API Postman Collection to include **all 19** newly deployed
edge functions for the taxi/ride service and platform settings (Phase 1 & Phase
2).
...
**Version**: 1.2.0 **Date**: December 1, 2025 **Total Endpoints**: 98+ **New
Endpoints**: 19
