...
This guide covers all the configuration you need to update in your Supabase
dashboard for the Giga platform, including the new social media and calls
features.
...
3. **Update `initiate-call` Function:** The current implementation uses a
   placeholder token generator. You'll need to:
   ...
   - See:
     [Agora Token Generation Guide](https://docs.agora.io/en/video-calling/develop/authentication-workflow)
