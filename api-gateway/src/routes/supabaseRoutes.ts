 ...
 *         schema:
 *           type: string
 *           enum: [user, driver, vendor, courier, admin]
 *       - in: query
 *         name: status
 *         schema:
 *           type: string
 ...
 *   get:
 *     summary: Manage vendors (Admin)
 *     description: Get list of vendors with filtering
 *     tags:
 *       - Admin Panel
 *     parameters:
 *       - in: query
 ...
 *   get:
 *     summary: Manage content (Admin)
 *     description: Get reported content for moderation
 *     tags:
 *       - Admin Panel
 *     parameters:
 *       - in: query
...
/**
 * @openapi
 * /api/v1/admin/financial-reports:
 *   get:
 *     summary: Get financial reports (Admin)
 *     description: Get platform financial reports
 *     tags:
 *       - Admin Panel
 *     parameters:
 *       - in: query
 ...
 *         schema:
 *           type: string
 *           enum: [revenue, commissions, payouts]
 *     responses:
 *       200:
 ...
 *     description: Process a vendor/driver payout request
 *     tags:
 *       - Admin Panel
 *     parameters:
 *       - in: path
