...
- **All Services**: \`GET /health/services\`
    ...
    tags: [
      ...
      {
        name: 'Authentication',
        description: 'User authentication via Supabase Auth (signup, login, logout)',
      },
      { name: 'User Management', description: 'User profiles, addresses, and settings (Supabase)' },
      {
        name: 'Role Management',
        description: 'Apply for roles, switch roles, admin review (Supabase)',
      },
      { name: 'Hotels', description: 'Hotel search, details, and management (Supabase)' },
      { name: 'Rooms', description: 'Room types, availability, and pricing (Supabase)' },
      { name: 'Bookings', description: 'Hotel booking operations (Supabase)' },
      { name: 'Reviews', description: 'Hotel and service reviews (Supabase)' },
      { name: 'E-commerce', description: 'Shopping cart, checkout, and orders (Supabase)' },
      { name: 'Taxi/Ride', description: 'Ride requests, drivers, and tracking (Supabase)' },
      { name: 'Payments', description: 'Wallet, Paystack, escrow, and payouts (Supabase)' },
      { name: 'Calling', description: 'Voice and video calls between users (Supabase)' },
      { name: 'Files', description: 'File uploads and image processing (Supabase)' },
      { name: 'Support', description: 'Support tickets and customer service (Supabase)' },
      { name: 'Notifications', description: 'Push notifications and alerts (Railway Service)' },
      { name: 'Social Media', description: 'Posts, comments, likes, feed (Railway Service)' },
      { name: 'Search', description: 'Search functionality (Railway Service)' },
      { name: 'Admin', description: 'Administrative functions and role review' },
      { name: 'Dashboard', description: 'GIGA Dashboard statistics (Railway Admin Service)' },
      {
        name: 'Business Modules',
        description: 'E-commerce, taxi, hotel, media analytics (Railway Admin Service)',
      },
      {
        name: 'Postal Monitoring',
        description: 'Postal staff management (Railway Admin Service)',
      },
      {
        name: 'Manager Operations',
        description: 'Post office manager endpoints (Railway Admin Service)',
      },
      {
        name: 'Advertisement Management',
        description: 'Ad review workflow (Railway Admin Service)',
      },
      { name: 'Admin Panel', description: 'Administrative settings (Railway Admin Service)' },
    ],
    components: {
      securitySchemes: {
        BearerAuth: {
