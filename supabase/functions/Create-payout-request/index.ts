    ...
    return new Response(
      JSON.stringify({
        ...
        data: {
          ...
          estimated_processing: result.has_mock_payments
            ? 'Instant (mock mode)'
            : '1-3 business days',
          next_steps: result.has_mock_payments
            ? 'Mock payout completed automatically'
            : 'Admin will review and process your payout request',
        },
      }),
      {
        headers: {
