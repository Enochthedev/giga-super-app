...
serve(async req => {
  ...
  try {
    ...
    const useMockProvider =
      ...
      Deno.env.get('USE_MOCK_PAYMENT') === 'true' ||
      ...
      await supabaseClient
        ...
        .update({
          ...
          metadata: {
            ...
            mock_payment: true,
            mock_instructions:
              'This is a test payment. Use the mock payment page to simulate success/failure.',
          },
        })
        .eq('id', payment.id);
        ...
        data: {
          ...
          ...(useMockProvider && {
            test_instructions: {
              ...
              how_to_test:
                'Visit the payment_url and click "Simulate Success" or "Simulate Failure"',
