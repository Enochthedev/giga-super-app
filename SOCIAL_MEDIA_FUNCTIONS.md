...
- **Body**: `{ "postId": "uuid", "content": "Updated text", "media_urls": [], "visibility": "public" }`
...
- **Method**: POST
- **Auth**: Required
- **Body**: `{ "postId": "uuid", "content": "Optional comment", "visibility": "public" }`
...
- **Method**: POST
- **Auth**: Required
- **Body**: `{ "postId": "uuid", "reactionType": "like|love|haha|wow|sad|angry" }`
...
- **Method**: POST
- **Auth**: Required
- **Body**: `{ "postId": "uuid", "content": "Comment text", "parentCommentId": "uuid" }`
...
- **Method**: POST
- **Auth**: Required
- **Body**: `{ "targetUserId": "uuid", "connectionType": "friend|follower|family|colleague" }`
...
- **Method**: POST
- **Auth**: Required
- **Body**: `{ "participantIds": ["uuid"], "conversationType": "direct|group", "name": "Group name" }`
