...
export declare const httpRequestErrors: Counter<
  'service' | 'method' | 'route' | 'status_code' | 'error_type'
>;
...
export declare const externalServiceDuration: Histogram<
  'service' | 'operation' | 'status' | 'service_name'
>;
export declare const externalServiceErrors: Counter<
  'service' | 'error_type' | 'operation' | 'service_name'
>;
 ...
 */
export declare const metricsMiddleware: (
  serviceName: string
) => (req: Request, res: Response, next: NextFunction) => void;
/**
 * Database query metrics wrapper
 */
export declare const trackDatabaseQuery: <T>(
  operation: string,
  table: string,
  serviceName: string,
  queryFn: () => Promise<T>
 ...
 */
export declare const trackExternalService: <T>(
  serviceName: string,
  operation: string,
