...
exports.clearMetrics =
  exports.getMetricsContentType =
  exports.getMetrics =
  exports.trackExternalService =
  exports.trackDatabaseQuery =
  exports.metricsMiddleware =
  exports.activeConnections =
  exports.businessEvents =
  exports.cacheMisses =
  exports.cacheHits =
  exports.externalServiceErrors =
  exports.externalServiceDuration =
  exports.databaseConnectionPool =
  exports.databaseQueryTotal =
  exports.databaseQueryDuration =
  exports.httpRequestErrors =
...
const trackExternalService = async (serviceName, operation, currentService, callFn) => {
  ...
  try {
    ...
    const duration = (Date.now() - start) / 1000;
    exports.externalServiceDuration.observe(
