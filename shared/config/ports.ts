...
export const SERVICE_PORTS = {
  ...
  HOTELS_SERVICE: parseInt(process.env.HOTELS_SERVICE_PORT || '3008', 10),
} as const;

export const SERVICE_URLS = {
  API_GATEWAY: process.env.API_GATEWAY_URL || `http://localhost:${SERVICE_PORTS.API_GATEWAY}`,
  SOCIAL_SERVICE:
    process.env.SOCIAL_SERVICE_URL || `http://localhost:${SERVICE_PORTS.SOCIAL_SERVICE}`,
  PAYMENT_QUEUE_SERVICE:
    process.env.PAYMENT_QUEUE_SERVICE_URL ||
    `http://localhost:${SERVICE_PORTS.PAYMENT_QUEUE_SERVICE}`,
  DELIVERY_SERVICE:
    process.env.DELIVERY_SERVICE_URL || `http://localhost:${SERVICE_PORTS.DELIVERY_SERVICE}`,
  NOTIFICATIONS_SERVICE:
    process.env.NOTIFICATIONS_SERVICE_URL ||
    `http://localhost:${SERVICE_PORTS.NOTIFICATIONS_SERVICE}`,
  ADMIN_SERVICE: process.env.ADMIN_SERVICE_URL || `http://localhost:${SERVICE_PORTS.ADMIN_SERVICE}`,
  TAXI_REALTIME_SERVICE:
    process.env.TAXI_REALTIME_SERVICE_URL ||
    `http://localhost:${SERVICE_PORTS.TAXI_REALTIME_SERVICE}`,
  SEARCH_SERVICE:
    process.env.SEARCH_SERVICE_URL || `http://localhost:${SERVICE_PORTS.SEARCH_SERVICE}`,
  HOTELS_SERVICE:
    process.env.HOTELS_SERVICE_URL || `http://localhost:${SERVICE_PORTS.HOTELS_SERVICE}`,
} as const;
